...
const TOP_PAGES = ['', 'plugins', 'meme', 'submit', 'about', 'install']
const LOCALES = ['en', 'zh']
...
const DOJO_PAGES = ['dojo', 'dojo/step-01', 'dojo/step-02', 'dojo/step-03', 'dojo/step-04', 'dojo/step-05', 'dojo/step-07', 'dojo/step-08', 'dojo/step-09', 'dojo/step-10'].map((p) => `/${p}`)
