...
（"已生成 1 张图片…"）            │
                                 ▼
                   <img src="https://raw.githubusercontent.com/Github-CJX/dsh-tool-imagegen/ac62a4dd1a750962e61b640c43e6c088ba8a202f/api/dsh-tool-imagegen/attachment%3Fsession%3D%E2%80%A6%26id%3D%E2%80%A6">
...
| 生成图时对话里多出一张毫不相干的图片 | c7 的 markdown 渲染器开始渲染 `![...](https://raw.githubusercontent.com/Github-CJX/dsh-tool-imagegen/ac62a4dd1a750962e61b640c43e6c088ba8a202f/http(s)://...)`；模型从信封得知「图片已生成」后自己写 markdown 图片引用（URL 为模型幻觉） | 升级插件到最新版（信封与系统提示已明确告知模型「图片已直接显示，请勿在回复中引用图片」） |
