...
![Conversation screenshot](https://raw.githubusercontent.com/wss534857356/dsh-plugin-codex/f6abe631bb181d4431cd20b1c9030779e56381b6/docs/images/conversation-screenshot.png)

![Model selector](https://raw.githubusercontent.com/wss534857356/dsh-plugin-codex/f6abe631bb181d4431cd20b1c9030779e56381b6/docs/images/model-selector-screenshot.png)
...
- `temperature`, `maxTokens`, and `stop` are rejected because App Server `0.147.0` exposes no reliable equivalents. Auxiliary calls that require `maxTokens`, including LLM-backed session titles and basic compaction, must route to another provider; configure `compaction-basic` with a `summarizationProvider`/`summarizationModel` pair that supports an output cap.
