...
- **工作区白名单**：子用户只能打开你指定的文件夹，看不到别的；会话工作区也按归属和白名单双重校验，无法读取其他账号的会话
- **会话与消息隔离**：子用户只能看到自己创建且仍在授权工作区内的会话；留言只显示广播、发给自己或自己发出的内容
...
| | 设置页卡片 · 权限与配额 | |
|:---:|:---:|:---:|
| | <img src="https://raw.githubusercontent.com/slywalker2006/dsh-passwords/d2dbca57203de9b3d2768121af153d5333e0e671/docs/screenshots/card-back.png" width="360"> | |
## 快速开始
