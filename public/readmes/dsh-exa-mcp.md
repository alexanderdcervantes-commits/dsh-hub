...
| DeepSeek Harness CLI (`@deepseek-ai/dsh`) | **≥ 0.1.0-rc.5**, tested on **0.1.0-rc.7** | The CLI ships the `@deepseek-ai/dsh-mcp-client` bridge this bundle mounts |
| MCP bridge (`@deepseek-ai/dsh-mcp-client`) | `^0.1.0-rc.7` (resolved from the dsh CLI) | No separate install needed |
