...
│         └─ 图片块 → <img src="https://raw.githubusercontent.com/wang-bool/visual-review/0e2a4a6c2cbee9667b544e57f0232b2cc7ddcc21/vr-image/sha256%3Axxx">                  │
└───────────────┬─────────────────────────────────────────┬────────────┘
...
2. **`/vr-image` 路由（字节 → 渲染）**。客户端渲染槽把注解里的附件 ID 提取出来，渲染为 `<img src="https://raw.githubusercontent.com/wang-bool/visual-review/0e2a4a6c2cbee9667b544e57f0232b2cc7ddcc21/vr-image/%3Cid%3E">`；Host 端从附件存储读回图片字节返回。该路由**仅接受回环地址**（127.0.0.1 / ::1）的请求。
...
| :---: | :---: |
| <img src="https://raw.githubusercontent.com/wang-bool/visual-review/0e2a4a6c2cbee9667b544e57f0232b2cc7ddcc21/assets/qr-official-account.jpg" width="240" alt="公众号二维码" /> | <img src="https://raw.githubusercontent.com/wang-bool/visual-review/0e2a4a6c2cbee9667b544e57f0232b2cc7ddcc21/assets/qr-group.png" width="220" alt="交流群二维码" /> |
