...
const topPages = ['', 'plugins', 'plugins/skins', 'plugins/pets', 'plugins/vision', 'plugins/clients', 'plugins/ops', 'best', 'compare', 'compare/deepseek-harness-vs-claude-code', 'compare/deepseek-harness-vs-opencode', 'compare/deepseek-harness-vs-codex', 'meme', 'submit', 'about', 'install', 'launcher']
