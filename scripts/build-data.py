...
EXTRA = [
  ...
  dict(slug='dsh-tonghuashun', name='tonghuashun-webui（同花顺 WebUI）', repo='renat3u/tonghuashun-webui', section='absurd',
       image='/images/dsh-tonghuashun.webp',
       desc_zh='同花顺风格股票终端外壳，套在 DeepSeek Harness 上——核心隐喻是把 Token 消耗画成 K 线图：一次删掉 10,000 行死代码的大重构烧穿 61.40 亿 Token，K 线上一根大红烛拔地而起，代码变更子图则是一根大绿柱砸到底。股票行情式盯盘你的 agent 烧钱',
       desc_en='A Tonghuashun-style stock-trading terminal skin for DeepSeek Harness — the core metaphor renders Token consumption as a K-line chart: one big refactor that deleted 10,000 lines of dead code burned through 6.14 billion Tokens, spiking a giant red candle on the chart while the code-change subplot slams a green bar to the floor. Watch your agent burn money like a stock ticker',
       caption_zh='删一万行死代码，K 线拉出一根大红烛——用炒股的心态写代码，烧 Token 都变得有仪式感',
       caption_en='Delete 10k lines of dead code and a giant red candle pops on the chart — coding with a stock-trader mindset makes even burning Tokens feel ceremonial'),
